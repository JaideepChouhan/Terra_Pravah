      ...
      <div className="container-wide py-12">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            <Link to="/" className="text-2xl font-bold gradient-text font-display">
              Terra Pravah
            </Link>
            <p className="mt-4 text-sm text-dark-400">
              AI-powered drainage design platform for engineering professionals.
            </p>
        ...
        <div className="mt-12 pt-8 border-t border-dark-800 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-dark-500">
            © {new Date().getFullYear()} Terra Pravah. All rights reserved.
          </p>
